...
public class PrinterFunctions {
    ...
    public static byte[] createPrinterData(ICommandBuilder.AlignmentPosition alignmentPosition,
                                           boolean emphasis,
                                           Emulation emulation,
        ...
        builder.appendAlignment(alignmentPosition);
        builder.appendEmphasis(emphasis);
        builder.append(text.getBytes());

package com.nerdvana.positiveoffline.functions;
...
//        builder.appendCodePage(CodePageType.Blank); builder.append("*Blank*\n".getBytes());
    ...
    public static byte[] createBitmapData(Emulation emulation, int width, Context context) {
        Bitmap sphereImage   = BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_launcher_background);
        Bitmap starLogoImage = BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_launcher_background);
...
//      rect = new Rect(0, 0, width,  height);
    ...
    public static byte[] createPrintableAreaData(Emulation emulation, PrintableAreaType type, Context context) {
        ...
        Bitmap printableAreaImage = BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_launcher_background);
